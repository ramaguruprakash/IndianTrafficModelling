...
def drawVehiclesWithSimulation(output, vehicles, prev_vehicles, simulated_vehicles, prev_speeds=None):
    ...
    if simulated_vehicles.size != 0:
        ...
        feature_vecs = getFeatureVecs(simulated_vehicles, prev_speeds, speeds, lanes_frames, lanes) # Where speeds is a dictionary of vehicle Id to speed.
    else:
        feature_vecs = []
    ...
    return output, simulated_vehicleis, speeds
