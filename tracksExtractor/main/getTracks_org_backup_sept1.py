...
#print visual.shape, " visual"
		...
		frames[track.track[-1][0]][track.track[-1][1]] = [255,255,0]
	return frames
...
for fno in range(total_frames):
	...
	flow, w, h= getDenseflowPreComputed("../output/Trimmed_trafficVideo_flow_output/tv"+str(fno)+"-"+str(fno+1)+".flo")  #Get the flow from the frame
